...
const termsSections = (operatorName: string) => [
  ...
  ["11. Usage limits", "CraveAI may apply daily chat, Places-search, voice, feedback, burst, and service-wide limits. Guest daily limits may be temporarily disabled during public testing, but burst and service-wide safeguards continue to apply. Current plan limits are shown in the product or Pricing page and may be adjusted prospectively to protect security, reliability, and provider costs. Attempting to evade limits is prohibited."],
