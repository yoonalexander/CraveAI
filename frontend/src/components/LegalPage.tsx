...
const termsSections = (operatorName: string) => [
  ...
  ["11. Usage limits", "CraveAI applies daily chat, Places-search, voice, feedback, burst, and service-wide limits. Current plan limits are shown in the product or Pricing page and may be adjusted prospectively to protect security, reliability, and provider costs. Attempting to evade limits is prohibited."],
