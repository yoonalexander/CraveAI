...
const helpArticles = [
  ...
  { id: "quotas", title: "Guest and Free quotas", body: "Guest and Free accounts have server-enforced daily ceilings. The current limits appear on the Pricing page and reset daily." },
