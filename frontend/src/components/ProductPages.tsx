...
const helpArticles = [
  ...
  { id: "quotas", title: "Guest and Free quotas", body: "Guest daily ceilings are currently disabled during public testing. Short-term burst protection and service-wide provider-cost safeguards still apply. Free account limits and any future guest limits appear on the Pricing page." },
